...
import com.kverma.journalApp.service.JournalEntryService;
...
public class JournalEntryControllerV2 {
    ...
    @PostMapping("/create")
    public ResponseEntity<JournalEntry> createEntry(@RequestBody JournalEntry myEntry) { // take the data from request and turn it into a java object that can be used in the code

        System.out.println("Received request for /create");
        try {
            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
            String userName = authentication.getName();
